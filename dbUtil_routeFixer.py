    ...
    if cur != None:
        try:
            cur.execute("""WITH test AS (SELECT *
                                    ...
                                    SELECT q5.step_id, step_index, max,start_link, from_ref_nodeid AS start_link_start_node, to_ref_nodeid AS start_link_end_node, end_link, from_ref_nodeid AS end_link_start_node, to_ref_nodeid AS end_link_end_node
                                    FROM
                                    (
